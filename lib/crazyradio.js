...
Crazyradio.prototype.setupRadio = function(device, channel, datarate)
{
	...
	// Last-ditch heartbeat to get data from the copter every 160ms.
	this.pingInterval = setInterval(this.ping.bind(this), 2000);
...
Crazyradio.prototype.onReadable = function()
{
	...
	// this line makes the CF choke which sometimes prevents the radio from connecting again.
	this.pingTimer = setTimeout(this.ping(), 160);
